...
if __name__ == '__main__':
    ...
    def usage():
        ...
        print "        [-C]  charges to add type:"
        print "             'gasteiger': addition of gasteiger charges"
        print "             'Kollman': addition of Kollman charges"
        print "             (default is 'None' which means preserve all input charges ie do not add new charges)"
    ...
    repairs = ''
    #-C default: preserve all input charges ie do not add new charges
    charges_to_add = None
